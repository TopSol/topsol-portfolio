...
export default function PortfolioCard({
  ...
  return (
    <div>
      <div
        className={`flex flex-col  md:container md:mx-auto items-center ${textColor} ${direction}`}
      >
        ...
        <div className="md:w-1/2 flex flex-col  justify-between mx-5 md:mx-0 ">
          <h1
            className={` text-xl  md:text-[25px] font-semibold font-montserrat text-primary ${textColor} `}
          >
