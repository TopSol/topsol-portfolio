...
export default function PortfolioCard({ data, index, textColor, subTitleColor, lineColor }) {
  return (
    <div>
      <div
      ...
      >
        ...
        >
          ...
          <h3 className={`text-[25px] lg:text-[30px] xl:text-[40px] leading-normal font-semibold my-[16px] xl:my-[37px] ${textColor}`}>
            {data?.title}
          </h3>
          <div className={`font-medium text-[20px]  ${textColor}`}
