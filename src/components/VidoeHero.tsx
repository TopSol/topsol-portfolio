...
export default function VideoHero({ title, image, page }: Iprops) {
  ...
  return (
    <div className=" ">
      <div
        className={`lg:h-[70vh] h-[90vh]  flex items-center ${
          page === "services" ? "none" : "bg-cover "
        }`}
        style={{
          ...
          <div className="   mx-6   md:mx-auto md:w-[90%] ">
            <div className="  ">
              <h1 className="text-4xl  text-center md:text-start lg:text-[60px] font-bold font-urbanist uppercase">
                ...
                <span className="text-primary font-bold font-urbanist ">
                  {lastName}
                </span>
              </h1>
              <h3
                className={`text-center md:text-start md:text-[22px]  font-figtree font-light  ${
                  page === "services" || "about"
                    ? "text-white"
                    : "text-textColors"
                } hero-text-sideLine   lg:w-[75%] mt-[56px]`}
              >
