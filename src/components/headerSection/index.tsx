  ...
  return (
    <div className=' bg-primary py-[120px]'>
      <div className='md:container  md:mx-auto   flex flex-col justify-center  text-center  '>
        <h1 className='text-3xl md:text-5xl lg:text-6xl xl:text-[70px] mb-0 md:mb-[21px] font-urbanist  text-white font-bold'>BLOGS & <span className='text-textColors font-urbanist font-bold'>ARTICLES</span></h1>
