  ...
  return (
    <div className="flex flex-col md:flex-row  md:container md:mx-auto items-center  my-20 justify-center">
      ...
      <div className="   text-center md:text-left flex flex-col  mt-6 lg:mt-12 md:w-[40%] w-[90%]">
        <p className=" text-[24px] font-figtree font-normal  capitalize  text-[#004264]">{heading}</p>
        <h1 className="  text-[20px] lg:text-[25px] text-primary font-urbanist xl:text-[30px] font-normal  mt-[10px] xl:mt-[34px] ">
          {mainHeading}
        </h1>
