        ...
        <div className="grid mt-[36px] md:mt-[95px] gap-x-[30px] gap-y-[30px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3   ">
          {workFlowData &&
            workFlowData?.map((item, index) => (
              <div
                className="px-[25px] shadow-md arrowhide  mx-5 md:mx-0 p-2 bg-white  hover:border-primary hover:border-2 border-2 border-white rounded-xl  py-6 hover:scale-[1.02] "
              ...
              >
                ...
                <p className="text-[18px] my-2 font-figtree leading-[125%] font-light">
                  {item?.text}
                </p>
              </div>
            ))}
