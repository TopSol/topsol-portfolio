...
export default function index() {
  return (
    <div>
      <Navbar />
      <div className=' pb-[176px] md:pt-[112px] bg-gradient-to-b from-secondary to-primary'>
...
<h1 className="text-[36px] md:text-[70px] xl:text-[90px]  text-white font-[600]">
      What is <br />
      <span className="md:inline text-blue-500">data </span><br />
      <span className="md:inline">Science</span>
    </h1>
</div>
...
<div className=" flex justify-center items-center md:justify-start md:items-start">
  <img
    src={line}
    className="w-[103px] md:w-[307px] md:ml-[139px] h-[7px] mt-[21px] md:mt-[25px]"
    alt=""
  />
</div>
...
<div className='mt-[40px] md:mt-[50px] mx-[37px] md:container md:mx-auto  md:flex flex-col  justify-center hidden'>
...
<div className=" flex justify-center items-center md:justify-start md:items-start">
  <img
    src={line}
    className="w-[103px] md:w-[172px] md:ml-[80px] h-[7px] mt-[21px] md:mt-[25px]"
    alt=""
  />
</div>
...
transforming raw information into actionable intelligence</p>
      ...
      <div className=' mt-[96px]  bg-gradient-to-b from-secondary to-primary pb-[86px]'>
