        ...
        <div className="w-[95%]  md:mb-[39px]  ">
          <div className="flex  bg-white rounded-lg py-[20px] px-[20px] ">
            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none" >
              <path d="M15.5833 8.5C19.4953 8.5 22.6667 11.6713 22.6667 15.5833M23.6 23.5944L29.75 29.75M26.9167 15.5833C26.9167 21.8426 21.8426 26.9167 15.5833 26.9167C9.3241 26.9167 4.25 21.8426 4.25 15.5833C4.25 9.3241 9.3241 4.25 15.5833 4.25C21.8426 4.25 26.9167 9.3241 26.9167 15.5833Z" stroke="#00B8F1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <input
