        ...
        <div>
            ...
            <div className='md:w-[70%] md:justify-center md:mx-auto'>
                <div className='mt-[118px] md:container md:mx-auto  flex flex-col justify-center items-center md:justify-start md:items-start'>
                    <div>
                        <h1 className=' text-center text-black font-semibold text-[22px] md:text-[30px] lg:text-[40px]'>Ready to discuss your project?</h1>
                    </div>
                ...
                <div className='mt-[49px]  md:container md:mx-auto  flex flex-col md:flex-row  justify-center items-center '>
                    ...
                    <div className="mb-[24px] md:mr-[21px] w-[85%]  md:container md:mx-auto justify-center">
                        <input
                            type="text"
                            className="px-[10px] py-[17px] font-medium  text-[18px] text-light_Grey outline-none rounded-md w-[100%]  bg-primary-formInput"
                            placeholder="Name*"
                        />
                    </div>
                    <div className="mb-[24px] w-[85%]  md:container md:mx-auto justify-center ">
                        <input
                            type="text"
                            className="px-[10px] text-[18px] font-medium  py-[17px] text-light_Grey outline-none rounded-md w-[100%] bg-primary-formInput "
                            placeholder="Email*"
                        />
                    </div>
                </div>
                ...
                <div className='  md:container mx-auto  flex flex-col md:flex-row  justify-center items-center '>
                    ...
                    <div className="  mb-[24px] md:mr-[21px] w-[85%] ">
                        <input
                            type="text"
                            className="px-[10px] text-[18px] font-medium py-[17px] text-light_Grey w-[100%] outline-none rounded-md   bg-primary-formInput"
                            placeholder="Organization*"
                        />
                    </div>
                    <div className="  mb-[24px] font-medium  text-[18px] w-[85%] text-light_Grey bg-primary-formInput">
                        <PhoneInput
                            inputStyle={{
                                width: "100%",
                                border: "none",
                ...
                <div className="w-[100%] md:container md:mx-auto flex flex-col justify-center items-center  ">
                    <div className='w-[85%] md:w-[100%] '>
                        <textarea
                            className=" outline-none font-medium  text-[18px] text-light_Grey px-[10px] py-[17px] h-[100px] md:h-[194px] bg-primary-formInput  rounded-md w-[100%]"
                            placeholder="Massage*"
                        ></textarea>
                    </div>
                </div>
                <div className="mt-[49px] md:container md:mx-auto flex flex-col md:flex-row  justify-center items-center">
                    <div className=" w-[85%] flex items-center mb-4 md:mb-0">
                        ...
                        />
                        <label className="ml-2 text-[15px] font-medium  text-light_Grey md:text-[12px] lg:text-[18px] ">I agree to terms &amp; conditions</label>
                    </div>
                    <div className='w-[85%]'>
                        <button
                            className={` w-[100%]  py-[12px] font-medium  text-center px-[37px] rounded  text-[18px]   ${isChecked ? ' bg-primary text-white cursor-pointer hover:bg-primary-lighter' : 'bg-primary text-white hover:bg-primary-lighter cursor-not-allowed '
                                }`}
                            disabled={!isChecked}
                        >
                            Send Message
