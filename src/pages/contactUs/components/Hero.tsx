  ...
  return (
    <div className=' bg-primary py-[120px]'>
      <div className='md:container  md:mx-auto mx-3   flex flex-col justify-center  text-center  '>
        <h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-[70px] mb-0 md:mb-[21px] font-urbanist  text-white font-bold'>CONTACT <span className='text-textColors'>US</span></h1>
