      ...
      <div className=" mt-[53px] grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2  grid-cols-1 gap-x-[30px]  ">
        {cardData.slice(0, visibleCards).map((card, index) => (
          <Link to={"/portfolio"}>
            <div
              key={index}
              className="rounded group hover:origin-left hover:scale-x-105 duration-300 hover:border-none 
            ...
            >
              <div className="  ">
                <div className="flex flex-col items-center ">
                  <img
                    src={card.image}
                    className=" my-[66px] group-hover:transition group-hover:duration-350 group-hover:scale-110
      ...
      <div className="flex justify-center items-center">
        <Link to={"/portfolio"}>
          <button
            ...
            items-center justify-center rounded bg-[#00B8F1] text-white hover:scale-x-125
