        ...
        {data.map((item, index) => (
          ...
          >
            <PrimaryBtn
              ...
              md:mx-0 font-semibold hover:bg-primary text-white font-montserrat ${selectedCategory === item.value
                  ? "active-category"
                  : "bg-primary-light"
                }`}
            />
